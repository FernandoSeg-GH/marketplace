...
function Header() {
    ...
    return (
        <header>
            {/* Top Nav */}
            <div className="flex items-center bg-corderitos_blue p-1 flex-grow py-2">
                ...
                <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
                    <div onClick={!session ? signIn : signOut} className="cursor-pointer hover:underline link">
                        <p>
                    ...
                    <div onClick={() => router.push('/checkout')} className="relative cursor-pointer hover:underline link flex items-center ">
